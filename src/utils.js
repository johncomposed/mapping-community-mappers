...
var db_path = exports.db_path = join(__dirname, '..', 'db');
exports.domain = 'achr.net';
exports.freezer = join(db_path, 'freezer.json');
...
exports.hostname = (link) => parse(link).hostname;
